...
@Getter
@Builder
@Schema(name = "DiscoverySearchStatisticsSummaryResponse", description = "Discovery 检索统计摘要响应")
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonIgnoreProperties(ignoreUnknown = true)
public class DiscoverySearchStatisticsSummaryResponse implements Serializable {
    ...
    @Getter
    @Builder
    @Schema(name = "DiscoverySearchStatisticsSummaryTopQueryResponse", description = "Discovery 热门搜索词响应")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonIgnoreProperties(ignoreUnknown = true)
