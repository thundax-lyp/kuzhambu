...
public class AdminTokenQueryResult {
    ...
    public static AdminTokenQueryResult inactive(String token) {
        AdminTokenQueryResult result = new AdminTokenQueryResult();
        result.setToken(token);
        return result;
    }

    public static AdminTokenQueryResult active(String token, PrincipalAuthSession session, User user, String username) {
        AdminTokenQueryResult result = new AdminTokenQueryResult();
