...
import com.thundax.kuzhambu.system.infra.core.persistence.assembler.DepartmentPersistenceAssembler;
import com.thundax.kuzhambu.system.infra.core.persistence.dataobject.DepartmentDO;
import com.thundax.kuzhambu.system.infra.core.persistence.mapper.DepartmentMapper;
...
public class DepartmentRepositoryImpl implements DepartmentRepository {
    ...
    public Department getById(DepartmentId id) {
        ...
        department = DepartmentPersistenceAssembler.toDomain(mapper.selectById(id.value()));
    ...
    public Page<Department> page(Long parentId, String name, String remarks, int pageNo, int pageSize) {
        ...
        entityPage.setRecords(DepartmentPersistenceAssembler.toDomainList(dataObjectPage.getRecords()));
        return entityPage;
    }
