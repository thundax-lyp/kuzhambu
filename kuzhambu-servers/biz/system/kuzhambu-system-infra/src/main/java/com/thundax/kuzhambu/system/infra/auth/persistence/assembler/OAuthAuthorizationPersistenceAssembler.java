...
public final class OAuthAuthorizationPersistenceAssembler {
    ...
    public static OAuthAuthorizationDO toObject(OAuthAuthorization entity) {
        if (entity == null) {
            return null;
        }
    ...
    public static OAuthAuthorization toDomain(OAuthAuthorizationDO dataObject) {
        if (dataObject == null) {
            return null;
        }
    ...
    public static List<OAuthAuthorization> toDomainList(List<OAuthAuthorizationDO> dataObjects) {
        if (dataObjects == null) {
            return null;
        }
