...
public final class PrincipalIdentityPersistenceAssembler {
    ...
    public static PrincipalIdentityDO toObject(PrincipalIdentity entity) {
        if (entity == null) {
            return null;
        }
    ...
    public static PrincipalIdentity toDomain(PrincipalIdentityDO dataObject) {
        if (dataObject == null) {
            return null;
        }
    ...
    public static List<PrincipalIdentity> toDomainList(List<PrincipalIdentityDO> dataObjects) {
        if (dataObjects == null) {
            return null;
        }
