...
public final class LogPersistenceAssembler {
    ...
    public static LogDO toObject(Log entity) {
        if (entity == null) {
            return null;
        }
    ...
    public static Log toDomain(LogDO dataObject) {
        if (dataObject == null) {
            return null;
        }
        Log entity = new Log();
    ...
    public static List<Log> toDomainList(List<LogDO> dataObjects) {
        if (dataObjects == null) {
            return null;
        }
    ...
    public static List<LogDO> toObjectList(List<Log> entities) {
        if (entities == null) {
            return null;
        }
        List<LogDO> dataObjects = new ArrayList<>();
        for (Log entity : entities) {
            dataObjects.add(toObject(entity));
        }
        return dataObjects;
    }
