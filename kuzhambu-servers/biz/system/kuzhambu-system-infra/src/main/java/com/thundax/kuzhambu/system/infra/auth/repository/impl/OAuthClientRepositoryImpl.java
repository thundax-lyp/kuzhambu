...
import com.thundax.kuzhambu.system.infra.auth.persistence.assembler.OAuthClientPersistenceAssembler;
import com.thundax.kuzhambu.system.infra.auth.persistence.dataobject.OAuthClientDO;
import com.thundax.kuzhambu.system.infra.auth.persistence.mapper.OAuthClientMapper;
...
public class OAuthClientRepositoryImpl implements OAuthClientRepository {
    ...
    public OAuthClientRepositoryImpl(OAuthClientMapper mapper) {
        this.mapper = mapper;
    }

    @Override
    public OAuthClient getById(EntityId id) {
        return OAuthClientPersistenceAssembler.toDomain(mapper.selectById(EntityIdCodec.toValue(id)));
    }
    ...
    public OAuthClient getByClientId(String clientId) {
        ...
        return OAuthClientPersistenceAssembler.toDomain(mapper.selectOne(wrapper));
    }
    ...
    public EntityId insert(OAuthClient client) {
        OAuthClientDO dataObject = OAuthClientPersistenceAssembler.toObject(client);
