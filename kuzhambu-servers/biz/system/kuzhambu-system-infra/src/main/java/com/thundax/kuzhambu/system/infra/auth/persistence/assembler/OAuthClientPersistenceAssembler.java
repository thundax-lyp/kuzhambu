...
public final class OAuthClientPersistenceAssembler {
    ...
    public static OAuthClientDO toObject(OAuthClient entity) {
        if (entity == null) {
            return null;
        }
    ...
    public static OAuthClient toDomain(OAuthClientDO dataObject) {
        if (dataObject == null) {
            return null;
        }
    ...
    public static List<OAuthClient> toDomainList(List<OAuthClientDO> dataObjects) {
        if (dataObjects == null) {
            return null;
        }
