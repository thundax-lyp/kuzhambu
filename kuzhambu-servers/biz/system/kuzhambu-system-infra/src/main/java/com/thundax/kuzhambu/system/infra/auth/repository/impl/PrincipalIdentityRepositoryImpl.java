...
import com.thundax.kuzhambu.system.infra.auth.persistence.assembler.PrincipalIdentityPersistenceAssembler;
import com.thundax.kuzhambu.system.infra.auth.persistence.dataobject.PrincipalIdentityDO;
import com.thundax.kuzhambu.system.infra.auth.persistence.mapper.PrincipalIdentityMapper;
import java.util.List;
import org.springframework.stereotype.Repository;

@Repository
public class PrincipalIdentityRepositoryImpl implements PrincipalIdentityRepository {

    private final PrincipalIdentityMapper mapper;
    private final SnowflakeIdGenerator idGenerator = new SnowflakeIdGenerator();

    public PrincipalIdentityRepositoryImpl(PrincipalIdentityMapper mapper) {
        this.mapper = mapper;
    }

    @Override
    public PrincipalIdentity getById(PrincipalIdentityId id) {
        return PrincipalIdentityPersistenceAssembler.toDomain(mapper.selectById(PrincipalIdentityIdCodec.toValue(id)));
    }
    ...
    public PrincipalIdentity getByIdentity(PrincipalIdentityType identityType, String identityValue) {
        ...
        return PrincipalIdentityPersistenceAssembler.toDomain(mapper.selectOne(wrapper));
    }
    ...
    public List<PrincipalIdentity> listByPrincipalKeyAndStatus(
        ...
        return PrincipalIdentityPersistenceAssembler.toDomainList(mapper.selectList(wrapper));
    }

    @Override
    public PrincipalIdentityId insert(PrincipalIdentity principalIdentity) {
        PrincipalIdentityDO dataObject = PrincipalIdentityPersistenceAssembler.toObject(principalIdentity);
