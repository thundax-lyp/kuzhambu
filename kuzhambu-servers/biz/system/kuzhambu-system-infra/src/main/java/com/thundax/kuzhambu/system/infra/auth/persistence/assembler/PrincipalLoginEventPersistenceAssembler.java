...
public final class PrincipalLoginEventPersistenceAssembler {
    ...
    public static PrincipalLoginEventDO toObject(PrincipalLoginEvent entity) {
        if (entity == null) {
            return null;
        }
    ...
    public static PrincipalLoginEvent toDomain(PrincipalLoginEventDO dataObject) {
        if (dataObject == null) {
            return null;
        }
    ...
    public static List<PrincipalLoginEvent> toDomainList(List<PrincipalLoginEventDO> dataObjects) {
        if (dataObjects == null) {
            return null;
        }
