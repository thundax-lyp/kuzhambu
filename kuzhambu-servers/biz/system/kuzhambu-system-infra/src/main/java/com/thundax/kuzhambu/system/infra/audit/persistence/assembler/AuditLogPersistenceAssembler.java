package com.thundax.kuzhambu.system.infra.audit.persistence.assembler;
...
public final class AuditLogPersistenceAssembler {
    ...
    public static AuditLogDO toObject(AuditLog entity) {
        if (entity == null) {
            return null;
        }
    ...
    public static AuditLog toDomain(AuditLogDO dataObject) {
        if (dataObject == null) {
            return null;
        }
    ...
    public static List<AuditLog> toDomainList(List<AuditLogDO> dataObjects) {
