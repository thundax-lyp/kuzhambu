...
public final class PrincipalCredentialPersistenceAssembler {
    ...
    public static PrincipalCredentialDO toObject(PrincipalCredential entity) {
        if (entity == null) {
            return null;
        }
    ...
    public static PrincipalCredential toDomain(PrincipalCredentialDO dataObject) {
        if (dataObject == null) {
            return null;
        }
    ...
    public static List<PrincipalCredential> toDomainList(List<PrincipalCredentialDO> dataObjects) {
        if (dataObjects == null) {
            return null;
        }
