...
import com.thundax.kuzhambu.system.infra.auth.persistence.assembler.PrincipalCredentialPersistenceAssembler;
import com.thundax.kuzhambu.system.infra.auth.persistence.dataobject.PrincipalCredentialDO;
import com.thundax.kuzhambu.system.infra.auth.persistence.mapper.PrincipalCredentialMapper;
...
public class PrincipalCredentialRepositoryImpl implements PrincipalCredentialRepository {
    ...
    public PrincipalCredential getById(PrincipalCredentialId id) {
        return PrincipalCredentialPersistenceAssembler.toDomain(
    ...
    public PrincipalCredential getByIdentityIdAndType(
        ...
        return PrincipalCredentialPersistenceAssembler.toDomain(mapper.selectOne(wrapper));
    }
    ...
    public List<PrincipalCredential> listByPrincipalKeyAndStatus(
        ...
        return PrincipalCredentialPersistenceAssembler.toDomainList(mapper.selectList(wrapper));
    }
