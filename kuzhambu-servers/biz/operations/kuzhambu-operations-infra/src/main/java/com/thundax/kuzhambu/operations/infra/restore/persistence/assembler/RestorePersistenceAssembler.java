    ...
    public static RestoreDO toObject(RestoreRecord entity) {
        return entity == null
                ...
                : new RestoreDO(
                        ...
                        entity.getRestoreMode(),
                        entity.getRestoreStatus(),
                        entity.getWriteBlockEnabled(),
                        entity.getWriteBlockStartedAt(),
                        entity.getWriteBlockReleasedAt(),
    ...
    public static RestoreRecord toDomain(RestoreDO dataObject) {
        return dataObject == null
                ...
                : new RestoreRecord(
                        ...
                        dataObject.getRestoreMode(),
                        dataObject.getRestoreStatus(),
                        dataObject.getWriteBlockEnabled(),
                        dataObject.getWriteBlockStartedAt(),
                        dataObject.getWriteBlockReleasedAt(),
