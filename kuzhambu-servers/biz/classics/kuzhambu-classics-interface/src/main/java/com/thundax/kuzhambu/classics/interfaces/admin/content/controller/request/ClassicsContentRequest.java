...
public class ClassicsContentRequest extends PageRequest {
    ...
    @JsonProperty("tagId") private Long tagId;
    ...
    @JsonProperty("exportKind") private String exportKind;
    @JsonProperty("exportFormat") private String exportFormat;
    @JsonProperty("scopeType") private String scopeType;
