...
class ClassicsSearchContentApplicationServiceImplTest {
    ...
    void listPublicContentsShouldAggregateThreeClassicsSources() {
        ...
        when(sancaiApplicationService.listEntries(org.mockito.ArgumentMatchers.any(SancaiEntryQuery.class)))
        ...
        when(wangqiDocumentApplicationService.listTimeline(org.mockito.ArgumentMatchers.any(WangqiDocumentQuery.class)))
        ...
        when(mingCustomsApplicationService.page(
                        org.mockito.ArgumentMatchers.any(MingCustomsQuery.class), org.mockito.ArgumentMatchers.any()))
