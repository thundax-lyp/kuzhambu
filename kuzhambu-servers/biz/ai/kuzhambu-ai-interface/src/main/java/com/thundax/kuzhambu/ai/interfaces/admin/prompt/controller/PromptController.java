...
import com.thundax.kuzhambu.ai.interfaces.admin.prompt.controller.response.PromptResponses;
...
public class PromptController {
    ...
    public PromptResponses.TemplateResponse getTemplate(@Valid @RequestBody PromptRequests.TemplateIdRequest request) {
    ...
    public PromptResponses.TemplateResponse getTemplateByScope(
            @Valid @RequestBody PromptRequests.TemplateQueryRequest request) {
    ...
    public PromptResponses.TemplateResponse saveTemplate(
            @Valid @RequestBody PromptRequests.TemplateSaveRequest request) {
    ...
    public PromptResponses.VersionResponse getCurrentVersion(
            @Valid @RequestBody PromptRequests.TemplateIdRequest request) {
    ...
    public List<PromptResponses.VersionResponse> listVersions(
            @Valid @RequestBody PromptRequests.TemplateIdRequest request) {
    ...
    public List<PromptResponses.VersionResponse> compareVersions(
            @Valid @RequestBody PromptRequests.VersionCompareRequest request) {
    ...
    public PromptResponses.VersionResponse rollbackVersion(
            @Valid @RequestBody PromptRequests.VersionRollbackRequest request) {
        return PromptInterfaceAssembler.toResponse(
    ...
    public List<PromptResponses.VariableResponse> listVariables(
            @Valid @RequestBody PromptRequests.TemplateIdRequest request) {
    ...
    public PromptResponses.VersionResponse buildOptimizationSuggestion(
