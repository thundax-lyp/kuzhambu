package com.thundax.kuzhambu.ai.application.prompt.command;
...
public class PromptTemplateSaveCommand {
    ...
    public PromptVersion toVersion(Long effectiveTemplateId, int versionNo, String variablesSnapshotJson) {
    ...
    public List<PromptVariable> toVariables(Long effectiveTemplateId) {
