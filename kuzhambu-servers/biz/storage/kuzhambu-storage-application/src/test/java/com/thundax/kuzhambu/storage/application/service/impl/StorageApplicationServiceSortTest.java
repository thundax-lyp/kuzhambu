...
class StorageApplicationServiceSortTest {
    ...
    @Test
    void sortShouldSwapPrioritiesWithinProvidedIdSubset() {
        ...
        verify(repository).updatePriority(StoredObjectId.of(3L), 20);
        verify(repository, times(3)).updatePriority(any(), anyInt());
    }
