...
final class StorageApplicationCommandQueryRecordAllowances {
    ...
    static List<ArchitectureRuleAllowance> legacyAllowances() {
        return List.of(
                legacy(
                        "COMMAND_QUERY_RECORD:com.thundax.kuzhambu.storage.application.command.AbortMultipartUploadCommand"),
                legacy(
                        "COMMAND_QUERY_RECORD:com.thundax.kuzhambu.storage.application.command.AddStorageReferencesCommand"),
                legacy("COMMAND_QUERY_RECORD:com.thundax.kuzhambu.storage.application.command.ChangeStorageCommand"),
                legacy(
                        "COMMAND_QUERY_RECORD:com.thundax.kuzhambu.storage.application.command.ChangeStorageObjectStatusCommand"),
                legacy(
                        "COMMAND_QUERY_RECORD:com.thundax.kuzhambu.storage.application.command.ChangeStorageReferenceStatusCommand"),
                legacy(
                        "COMMAND_QUERY_RECORD:com.thundax.kuzhambu.storage.application.command.CompleteMultipartUploadCommand"),
                legacy("COMMAND_QUERY_RECORD:com.thundax.kuzhambu.storage.application.command.CreateStorageCommand"),
                legacy(
