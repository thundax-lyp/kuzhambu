...
public class GraphPublishedSubgraph {
    ...
    public GraphPublishedMutationSet deleteNode(GraphPublishedNodeId nodeId, boolean cascadeEdges, Instant modifiedAt) {
        GraphPublishedNode node = requireNode(nodeId);
        GraphPublishedMutationSet changes = new GraphPublishedMutationSet();
    ...
    public GraphPublishedMutationSet deleteEdge(GraphPublishedEdgeId edgeId, Instant modifiedAt) {
    ...
    public GraphPublishedMutationSet mergeNodes(
    ...
    public GraphPublishedMutationSet splitNode(
            GraphPublishedNodeId sourceNodeId,
            GraphPublishedNode splitNode,
            List<GraphPublishedEdgeId> reassignedEdgeIds,
            Instant modifiedAt) {
        if (splitNode == null) {
            throw new DomainException("Graph published split node is required");
        }
        GraphPublishedNode sourceNode = requireNode(sourceNodeId);
        ...
        for (GraphPublishedEdgeId edgeId :
                reassignedEdgeIds == null ? List.<GraphPublishedEdgeId>of() : reassignedEdgeIds) {
            GraphPublishedEdge edge = requireEdge(edgeId);
