package com.thundax.kuzhambu.interfaces.admin.auth.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.thundax.kuzhambu.biz.auth.configure.AuthProperties;
...
import com.thundax.kuzhambu.biz.auth.exception.InvalidCaptchaException;
...
import com.thundax.kuzhambu.biz.auth.utils.PreAuthCodeHelper;
...
import com.thundax.kuzhambu.interfaces.admin.auth.assembler.AuthInterfaceAssembler;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.request.AuthLoginFormRefreshRequest;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.request.AuthLoginRequest;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.request.AuthLogoutRequest;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.request.AuthTokenRequest;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.request.GithubLoginRequest;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.request.OAuth2AuthorizeRequest;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.request.OAuth2DecisionRequest;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.request.OAuth2TokenRequest;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.request.SmsLoginRequest;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.request.TokenRefreshRequest;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.request.WecomLoginRequest;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.response.AuthAccessTokenResponse;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.response.AuthLoginFormResponse;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.response.OAuth2AuthorizationDecisionResponse;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.response.OAuth2AuthorizationViewResponse;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.response.OAuth2IntrospectionResponse;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.response.OAuth2UserinfoResponse;
import com.thundax.kuzhambu.interfaces.admin.auth.controller.response.TokenVerifyResponse;
