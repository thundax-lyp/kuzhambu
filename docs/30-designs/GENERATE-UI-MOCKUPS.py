...
MODULES = [
    ...
    },
    {
        ...
        "list_title": "长任务状态",
        "rows": ["批量标签提取", "三才视觉设定集", "手动备份", "知识图谱提取", "过期分享清理"],
        "detail_title": "运维指标",
    ...
    },
    {
        ...
        "crumb": "知识库 / 三才图会",
        "primary": "门类 / 卷 / 条目三级浏览",
        "stats": [("门类", "14"), ("卷", "106"), ("视觉资产", "319"), ("归档", "42")],
        "tabs": ["门类", "卷列表", "条目", "视觉资产", "导出", "静态展示"],
        "list_title": "门类导航",
        "rows": ["天文", "地理", "人物", "宫室", "器用"],
        "detail_title": "条目详情",
        "detail": ["原文 / 译文 / 标签 / 配图", "摘要与问答对内联维护", "视觉描述与 AI 生图", "草稿 / 发布 / 归档"],
        "right": ["50/100/200 分页", "当前卷内搜索", "展示页风险确认", "视觉设定集导出"],
    },
    {
