...
- [AI-CONFIG-PROMPT-REQUIREMENTS.md](./AI-CONFIG-PROMPT-REQUIREMENTS.md)：提供 AI 服务配置、模型能力和提示词模板后台管理。
- [AI-REFINEMENT-REQUIREMENTS.md](./AI-REFINEMENT-REQUIREMENTS.md)：提供翻译、摘要、标签、问答对、图片理解和条目拆分的候选确认流程。
