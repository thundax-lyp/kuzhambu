...
- [SANCAI-KNOWLEDGE-REQUIREMENTS.md](./SANCAI-KNOWLEDGE-REQUIREMENTS.md)、[WANGQI-DOCUMENT-REQUIREMENTS.md](./WANGQI-DOCUMENT-REQUIREMENTS.md)、[MING-CUSTOMS-REQUIREMENTS.md](./MING-CUSTOMS-REQUIREMENTS.md)、[VISUAL-ASSET-REQUIREMENTS.md](./VISUAL-ASSET-REQUIREMENTS.md)：提供内容统计、导出产物清理对象和长任务状态来源。
