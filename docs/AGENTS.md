...
- portal-web 前端命名、目录、分层、服务边界、UI 组件和门禁：`00-governance/ARCHITECTURE.md`、`00-governance/PORTAL-WEB-RULES.md`。
...
- 涉及 `Sortable`、`priority`、`orderedIds`、`*SortRequest` 或排序接口变更：`30-designs/SORT-ORDERING-SPECIAL-DESIGN.md`。
