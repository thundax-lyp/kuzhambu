...
- 无。当前阶段已承诺的 taxonomy、Classics 标签协作与 Knowledge 抽取任务闭环均已落地到仓库。
...
| 标签审核、合并和废弃操作审计                     | 部分完成 | 审核相关后端动作已具备明确写入口和权限控制                                                                                     | System 审计联调与合并/废弃审计能力当前仍未完成  | Knowledge, System      |
...
| 需求项                     | 状态   | 已完成部分 | 未完成部分                         | 责任域    |
| -------------------------- | ------ | ---------- | ---------------------------------- | --------- |
| 待精修内容筛选             | 未完成 | 需求已沉淀 | 当前仓库尚未提供数据精修工作台     | Knowledge |
| 实体确认、编辑、删除和新增 | 未完成 | 需求已沉淀 | 当前仓库尚未提供实体精修运行时代码 | Knowledge |
| 关系确认、编辑、删除和新增 | 未完成 | 需求已沉淀 | 当前仓库尚未提供关系精修运行时代码 | Knowledge |
| 人工确认状态               | 未完成 | 需求已沉淀 | 当前仓库尚未提供精修确认状态流转   | Knowledge |
| 按门类筛选待精修内容       | 未完成 | 需求已沉淀 | 当前仓库尚未提供精修筛选器         | Knowledge |
| 质量评估人工标注入口       | 未完成 | 需求已沉淀 | 当前仓库尚未提供质量标注入口       | Knowledge |
...
| 鸟瞰层、门类层和详情层图谱浏览             | 未完成 | 需求已沉淀                                                                                                                                                    | 当前仓库尚未提供图谱浏览 UI          | Knowledge                         |
| 鸟瞰层展示 14 大门类实体数量和分布         | 未完成 | 需求已沉淀                                                                                                                                                    | 当前仓库尚未提供图谱统计视图         | Knowledge                         |
| 门类层展示卷间关联和实体关系               | 未完成 | 需求已沉淀                                                                                                                                                    | 当前仓库尚未提供门类层图谱           | Knowledge                         |
| 详情层展示单实体信息、关系和来源条目       | 未完成 | 需求已沉淀                                                                                                                                                    | 当前仓库尚未提供实体详情图谱视图     | Knowledge                         |
| 鸟瞰、门类和详情面包屑导航                 | 未完成 | 需求已沉淀                                                                                                                                                    | 当前仓库尚未提供图谱导航             | Knowledge                         |
| 批量生成和重生成                           | 未完成 | 需求已沉淀                                                                                                                                                    | 当前仓库尚未提供批量图谱任务         | Knowledge, AI                     |
| 从质量报告或筛选结果批量触发提取           | 未完成 | 需求已沉淀                                                                                                                                                    | 当前仓库尚未提供图谱调度入口         | Knowledge, AI                     |
| 读取数据精修修正结果                       | 未完成 | 需求已沉淀                                                                                                                                                    | 当前仓库尚未提供精修与图谱联动       | Knowledge                         |
| 质量报告与指标展示                         | 未完成 | 需求已沉淀                                                                                                                                                    | 当前仓库尚未提供质量报告             | Knowledge                         |
...
| 需求项             | 状态     | 已完成部分                                                                                                                                                                   | 未完成部分                           | 责任域                            |
| ------------------ | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | --------------------------------- |
| 当前阶段运行时验证 | 部分完成 | 已完成 taxonomy 与图谱抽取后端专项测试、workers Knowledge usecase 契约测试、Admin Web `lint` / `build` / 页面级测试，以及 `node scripts/generate-system-data-sql.ts --check` | 缺少 Playwright 与跨服务联调冒烟记录 | Knowledge, AI, Workers, Admin Web |

## Unfinished Focus

| 能力项                              | 状态   | 说明                                                                                                   |
| ----------------------------------- | ------ | ------------------------------------------------------------------------------------------------------ |
| 数据精修                            | 未完成 | 当前仓库尚未提供待精修内容筛选、实体/关系人工确认和质量标注入口                                        |
| 图谱浏览与质量报告                  | 未完成 | 当前已交付抽取任务、候选应用、正式结果落库和后台读取页，但尚未提供图可视化浏览、统计大盘或质量报告页面 |
| 世系图浏览                          | 未完成 | 当前只交付世系抽取、正式结果落库和后台读取，不含可视化页面                                             |
| Portal 页面                         | 未完成 | 当前 Knowledge 能力仍主要落在 Admin 端，Portal 侧未形成可执行交付物                                    |
| 数据精修与图谱联动                  | 未完成 | 当前尚未把人工精修结果回灌到图谱提取或正式结果读取链路                                                 |
